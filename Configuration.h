...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 215, 0 }  // (mm) X posph6itions for parking the extruders
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 220 }
